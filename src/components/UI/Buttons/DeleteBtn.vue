...
const theEmit = defineEmits(["deleteTask"]);

const clickDelete = (event: Event) => {
...
<template>
  <button
    class="relative w-[24px] h-[24px] bg-transparent p-1 rounded-sm transition-all active:scale-90 hover:bg-blue-300"
    title="Удалить"
    @click="clickDelete"
  >
    <div class="w-[16px] h-[16px] absolute left-[4px] top-[4px]">
      <svg
        width="16px"
        height="16px"
        viewBox="0 0 32 32"
